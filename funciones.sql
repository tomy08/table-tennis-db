...
DELIMITER / / CREATE FUNCTION obtenerGanadorPartido (ID_partido INT) RETURNS INT READS SQL DATA BEGIN DECLARE ganador INT;
...
DELIMITER / / CREATE FUNCTION actualizarRanking (ID_partido INT) RETURNS VOID BEGIN DECLARE instancia_actual VARCHAR(50);
...
SELECT
    instancia INTO instancia_actual
FROM
    partido
WHERE
    ID = ID_partido;
...
SELECT
    rating INTO ranking_actual_jugador1
FROM
    jugador
WHERE
    ID = (
...
SELECT
    rating INTO ranking_actual_jugador2
FROM
    jugador
WHERE
    ID = (
...
SELECT
    obtenerGanadorPartido (ID_partido) INTO ganador_partido;
...
SET
    ranking_actual_jugador2 = ranking_actual_jugador2 + 45;
...
SET
    ranking_actual_jugador2 = ranking_actual_jugador2 + 30;
...
SET
    ranking_actual_jugador2 = ranking_actual_jugador2 + 15;
...
SET
    ranking_actual_jugador2 = ranking_actual_jugador2 + 2;
...
SET
    ranking_actual_jugador2 = ranking_actual_jugador2 - 5;
...
SET
    ranking_actual_jugador2 = ranking_actual_jugador2 - 10;
...
ELSE
SET
    ranking_actual_jugador2 = ranking_actual_jugador2 + 25;
